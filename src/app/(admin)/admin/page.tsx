...
export default function Admin() {
  ...
  // Check roles or other metadata from user
  const userRole = user?.publicMetadata?.role; // Access roles from publicMetadata
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        // Make the API request to the backend route (e.g., '/api/verify-token')
